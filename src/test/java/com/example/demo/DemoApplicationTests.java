...
public class DemoApplicationTests {
	...
	@Test
	public void sortTaskTestImportantFlag() {
		List<Task> tasks = new ArrayList<Task>();
		...
		assertEquals("Name is not correct", "Buy MilkD", tasks.get(0).getName());
		assertEquals("Date is not correct", "12/1/19", tasks.get(0).getDate());
		assertEquals("Time is not correct", "00:00", tasks.get(0).getTime());
		
		assertEquals("Name is not correct", "Buy MilkB", tasks.get(1).getName());
		assertEquals("Date is not correct", "12/1/19", tasks.get(1).getDate());
		assertEquals("Time is not correct", "14:00", tasks.get(1).getTime());

		assertEquals("Name is not correct", "Buy MilkA", tasks.get(2).getName());
		assertEquals("Date is not correct", "12/1/19", tasks.get(2).getDate());
		assertEquals("Time is not correct", "13:00", tasks.get(2).getTime());

		assertEquals("Name is not correct", "Buy MilkC", tasks.get(3).getName());
		assertEquals("Date is not correct", "12/1/19", tasks.get(3).getDate());
		assertEquals("Time is not correct", "15:00", tasks.get(3).getTime());
